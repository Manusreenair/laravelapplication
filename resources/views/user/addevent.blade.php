...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            "padding-top:15px;">
                <font color="white"><strong>User Dashboard</strong></font>
            </a>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                 ...
                 <li>
                    <a href="{{route('showaddevent')}}"><i class="fa fa-fw fa-plus"></i>  Add Events</a>
                </li>
                <li>
                    <a href="{{route('listevent')}}"><i class="fa fa-fw fa-eye"></i>  List Events</a>
                </li>
                ...
                <div id="response"></div>
                        ...
                        <form id="add_event">
                           ...
                           <div class="form-group">
                                ...
                                <input type="date" id="start_date" class="form-control" placeholder="Enter Start Date" required>
                           </div>
                           <div class="form-group">
                                <label>End date</label>
                                <input type="date" id="end_date" class="form-control" placeholder="Enter End Date" required>
                           </div>
                           <div class="form-group">
                                <label>Venue Details</label>
                                <textarea id="venue" class="form-control" placeholder="Enter Venue Details" required></textarea>
                           </div> 
                           
                           <div class="form-group">
                                <input type="submit" id="phoneno" class="btn btn-success" >
                           </div>     
...
$(document).ready(function()
{
    $('#add_event').on('submit',function(e)
    {
        ...
        $.ajaxSetup({
            ...
            $.ajax({
                type:"POST",
                url:"{{route('addEventApi')}}",
                dataType:"json",
                data:{title:title,description:description,start_date:start_date,end_date:end_date,venue:venue},
                success:function(data)
                {
                    if(data.status==1)
                    {
                        ...
                        $('<div class="alert alert-success">'+'<button type="button" class="close" data-dismiss="alert">'+'&times;</button>'+data.message+'</div>').hide().appendTo('#response').fadeIn(1000);
