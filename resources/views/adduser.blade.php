                ...
                <div id="response"></div>
                        ...
                        <form id="add_user">
                           ...
                           <div class="form-group">
                                ...
                                <input type="text" id="phoneno" class="form-control" placeholder="Enter Mobile No." required>
                           </div>
                           <div class="form-group">
    ...
    $('#add_user').on('submit',function(e)
    {
        ...
        $.ajaxSetup({
            ...
            $.ajax({
                ...
                dataType:"json",
                data:{email:email,password:password,mob_no:mob_no,name:name},
